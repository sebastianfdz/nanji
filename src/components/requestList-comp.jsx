...
export function RequestList({
  ...
  useEffect(() => {
    console.log('requestList-comp.jsx user: ', user);
    console.log('requestList-comp.jsx outGoing: ', outGoing);
    console.log('requestList-comp.jsx incoming: ', incoming);
  }, []);
  ...
  const handleIncomingRequest = async (currentUser, oppositeUser) => {
    ...
    console.log(
      'Incoming request @ requestList-comp line 70 : ',
      incomingRequests,
    );
    const reqIncoming =
  ...
  const handleOutgoingRequest = async (currentUser, oppositeUser) => {
    ...
    console.log(
      'Outgoing request @ requestList-comp line 93 : ',
      outgoingRequests,
    );
    const reqOutgoing =
    ...
    <>
      <div id="requestlist" onClick={dismissAlerts}>
        ...
        <div class="outgoing">
          ...
          {outGoing.map(req => {
            console.log('outgoing friend request @ reqList line 173 : ', req);
            return (
        ...
        <div class="incoming">
          ...
          {incoming.map(req => {
            console.log('incoming friend request @ reqList line 193 : ', req);
            return (
              <div class="individualrequest" key={req.id} id={req.id}>
                <div class="textinfo">
                  <p>Name: {req.given_name + ' ' + req.family_name}</p>
