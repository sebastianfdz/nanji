...
export function Search({ user, outGoing, setOutGoing, incoming, setIncoming }) {
  React.useEffect(() => {
    console.log('search-comp.jsx user: ', user);
    console.log('search-comp.jsx outGoing: ', outGoing);
    console.log('search-comp.jsx incoming: ', incoming);
  }, []);
  ...
  const searchHandler = async event => {
    ...
    if (results.length > 0) {
      console.log('Results @ search component line 41 : ', results);
